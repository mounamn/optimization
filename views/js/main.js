...
var resizePizzas = function(size) { 
  ...
  function determineDx (elem, size) {
    ...
    function sizeSwitcher (size) {
      switch(size) {
        case "1":
          return '25%'; // Changes the slider value to a percent width
        case "2":
          return '33.33%';
        case "3":
          return '50%';
  ...
  function changePizzaSizes(size) {
    ...
    for (var i = 0, len = randomPizza.length; i < len; i++) { // add the end value in the loop
      dx = determineDx(randomPizza[i], size);
...
var s = 256;
var elem;
var moving = document.querySelector("#movingPizzas1");
for (var i = 0; i < 40; i++) { // Reduce the number of moving pizzas from 200 to 40
